...
public class HomeWork extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double masa, varsta, inaltimea;
         ...
         varsta = Double.parseDouble(jTextField1.getText());
        inaltimea = Double.parseDouble(jTextField2.getText());
        masa = 50 + 0.75 * (inaltimea - 150) + 0.25 * (varsta - 20);
        
        jLabel4.setText("Masa ideala (barbat) = " + masa + " kg");
        jLabel3.setText("Masa ideala (femeie) = " + 0.9 * masa + " kg");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util
                .logging
                .Logger
                .getLogger(HomeWork.class.getName())
                .log(java.util
                         .logging
                         .Level
                         .SEVERE, null, ex);
