...
public class F extends javax.swing.JFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            jTable1.getColumnModel().getColumn(0).setHeaderValue("i");
            jTable1.getColumnModel().getColumn(1).setHeaderValue("x");
            jTable1.getColumnModel().getColumn(2).setHeaderValue("f(x)");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        /*
        i = 1;
        while (i <= n) { // start of the body
            x = a + (i - 1) * h;
            f = func(x); // call the method - function()
            Object[] row = { i, x, f };
            Table1.addRow(row);
        ...
        for (i = 1; i <= n; ++i) { // the body
            x = a + (i - 1) * h;
            f = func(x); // call the method - func()
            Object[] row = { i, x, f };
            Table1.addRow(row);
        }
       
        for (x = a, i = 1; i <= n; x += h, ++i) { // the body
            f = func(x); // call the method - func()
            Object[] row = { i, x, f };
            Table1.addRow(row);
        }
 */       
        ...
        //    Table1.addRow(new Object[] { i, x, func(x) });   
        
        for (x = a, i = 1; i <= n; Table1.addRow(new Object[] { i, x, func(x) }),x += h, ++i) ; 
